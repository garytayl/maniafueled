        ...
        <div className="relative py-16 md:py-24 px-8 md:px-12 border-t border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              >
                If this <span className="italic">resonates</span>
              </motion.h2>
              <motion.p
                className="font-mono text-xs tracking-wider mt-2 text-center md:text-left"
                animate={{
                  color: isHovered ? "#050505" : "rgba(255,255,255,0.6)",
                }}
                transition={{ duration: 0.3 }}
              >
                Reach out — or share with someone who needs to understand
              </motion.p>
            </div>
