...
export function DepressivePathContent() {
  return (
      ...
      <div className="px-8 md:px-12 pt-28 pb-24 max-w-4xl mx-auto">
        ...
        >
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="ideation" className="border-white/10">
              <AccordionTrigger className="font-mono text-sm tracking-wider text-muted-foreground hover:text-foreground py-6">
                Suicidal ideation
              </AccordionTrigger>
              <AccordionContent>
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <h2 className="font-sans text-2xl font-light mb-6">Cross-cutting struggles</h2>
          ...
          <div className="space-y-6">
            {crossCuttingStruggles.map((s, i) => (
              <div key={i} className="border-l border-white/20 pl-6">
                <h3 className="font-mono text-sm tracking-wider text-foreground mb-2">{s.title}</h3>
